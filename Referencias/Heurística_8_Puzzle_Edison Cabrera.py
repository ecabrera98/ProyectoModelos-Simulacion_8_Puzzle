...
PROFESOR: Dra. Myriam Hernández
FECHA DE ENTREGA: 26/06/2020
Autor:  Edison Daniel Cabrera Pabón

Laboratorio: 3 Heurística 8-PUZZLE

"""


# se estableció una clase NODO
class Node(object):
...
# se estableció una LISTA DOBLEMENTE ENLAZADA
#con 3 métodos para la correcta asignación de las posiciones de las reinas
...
# se estableció el ESCENARIO DE JUEGO
class Puzzle(object):
  ...
  def printPuzzle(self):
    ...
    print("_____ h(n)->{}  n->{} f(n)->{} explorado->{}".format(self.h, self.g, self.h 
                                                                + self.g, self.explorado))
    print('')
...
if __name__ == "__main__":
  ...
  #IMPRIME LISTA COMPLETA CON EL RESULTADO OBTENIDO
